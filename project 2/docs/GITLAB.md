...
Make the contents of `project 2` the root of its own GitLab repository so `.gitlab-ci.yml` is discovered automatically. No GitLab project or remote pipeline has been created by these files.
