...
- 7 Python unit/HTTP tests using Python 3.12. Container and CI images target Python 3.13.
...
- Strict Kubernetes 1.34 schema validation for 14 core resources, including rendered placeholders where applicable.
