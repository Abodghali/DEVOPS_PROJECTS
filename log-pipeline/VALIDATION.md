...
| Check | Result |
| --- | --- |
| Python tests | PASS: 3 test methods |
...
Test coverage: Valid/rejected events, deterministic reruns, and preservation of the previous report when all input is invalid.
...
The sample batch was also executed directly with Python: 3 accepted events, 1 rejected event, and a report written to ignored `output/report.json`.
