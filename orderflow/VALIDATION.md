...
## Collection update: 2026-09-25

The project folder was renamed without replacing application files. Its Python test suite and YAML/HCL parsing passed again. This update does not change the previously recorded runtime and cloud deployment limitations.
